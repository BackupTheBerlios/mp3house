 ...
 * </pre>
 */
public abstract class AccountManagerPOA extends org.omg.PortableServer.Servant
		implements
	...
	private static java.lang.String[] __ids = {"IDL:Bank/AccountManager:1.0"};
	...
	public org.omg.CORBA.portable.OutputStream _invoke(java.lang.String opName,
		...
		switch (method[0]) {
			case 0 :
				{
					return Bank.AccountManagerPOA._invoke(this, method[1],
							_input, handler);
				}
		}
		throw new org.omg.CORBA.BAD_OPERATION();
	...
	public static org.omg.CORBA.portable.OutputStream _invoke(
			Bank.AccountManagerOperations _self, int _method_id,
			org.omg.CORBA.portable.InputStream _input,

 ...
 * </pre>
 */
public class _AccountStub extends com.inprise.vbroker.CORBA.portable.ObjectImpl
		implements
			Bank.Account {
	...
	public float balance() {
		while (true) {
			if (!_is_local()) {
				...
				Bank.AccountOperations _self = null;
				...
				try {
					_self = (Bank.AccountOperations) _so.servant;
